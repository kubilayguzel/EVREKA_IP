...
export class BulkIndexingModule {
    ...
    async init() {
        try {
            ...
            // 🔥 DİKKAT: Sayfa açılış hızını artırmak için loadAllData() buradan kaldırıldı!
            // Portföy artık sayfa açılışında 6200+ kaydı boşa indirmeyecek. 
            // Sadece arama kutusuna bir şey yazıldığında veya PDF yüklendiğinde çekilecek.

            this.setupEventListeners();
            
            // this.updateUI(); // Eski listeleme fonksiyonu da kapalı kalmaya devam ediyor
        } catch (error) {
